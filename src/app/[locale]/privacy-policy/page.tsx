            ...
            <article className='prose prose-base max-sm:prose-p:text-xs max-sm:prose-li:text-xs px-2 md:px-0 dark:prose-invert md:prose-sm py-32 mx-auto lg:prose-lg xl:prose-xl prose-a:underline prose-a:text-blue-500'>
                ...
                <div>
                    ...
                    <ul>
                        ...
                        <li>
                            <p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to CodeLib.</p>
                        </li>
                        <li>
                        ...
                        <li>
                            <p><strong>Website</strong> refers to CodeLib, accessible from <a href="https://CodeLib.vercel.app" rel="external nofollow noopener" target="_blank">https://CodeLib.vercel.app</a></p>
                        </li>
                        <li>
                    ...
                    <ul>
                        <li>
                            <p>By email: itamarhanandev@gmail.com</p>
                        </li>
                    </ul>
                </div>
            </article>
